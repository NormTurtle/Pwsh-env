...
require'nvim-lastplace'.setup {
 ...
 -- require('wlsample.evil_line') -- evil
 -- require('leap').add_default_mappings()  -- Fast kangaroo
...
local status_ok, _ = pcall(vim.cmd, "colorscheme " .. colorscheme)
 ...
 --key.set("n", "<leader>P", ":e "$profile"<CR>")
  ...
  key.set('n', '<leader>ve', ":lua Toggle_venn()<CR>",{desc = " Draw Ascii Art"}, { noremap = true})
